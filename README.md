...
### Download the [tf+keras model](https://github.com/matterport/Mask_RCNN/releases) and run `python network/convert_weights.py` or download the converted model at [Dropbox](https://www.dropbox.com/s/6ccfqkc8rsiqsqe/mrcnn.pth?dl=0).
